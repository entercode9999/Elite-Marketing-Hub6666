...
const SERVICES = [
  {
    ...
    icon: MapPin,
    color: "#4f8aff",
    eyebrow: "Own the local map pack",
    headline: "Every local search — your business, first.",
    sub: "Most competitors set up GBP once and hope. We actively manage the citation signals, review velocity, and local content that keeps you visible across every area you serve.",
    bullets: [
      "GBP optimisation, citation signals, review velocity — systemised",
      "Map pack positions across the GTA service areas you care about",
      "Neighbourhood-specific landing pages that capture local intent",
    ],
  ...
  },
  {
    ...
    icon: FileText,
    color: "#a78bfa",
    eyebrow: "Content that generates leads",
    headline: "Content that compounds. Traffic that doesn't leave.",
    sub: "Not blog posts for the sake of it. We build structured content systems that signal to Google you're the go-to resource in your service area — and convert that traffic into enquiries.",
    bullets: [
      "Structured content clusters targeting your core service keywords",
      "Expert-written, locally relevant long-form content",
  ...
  },
  {
    ...
    icon: Bot,
    color: "#fbbf24",
    eyebrow: "AI-powered lead capture",
    headline: "Leads captured. Follow-up automated. Nothing falls through.",
    sub: "We build practical AI systems for local service businesses — chatbots that qualify leads 24/7, follow-up automation that converts enquiries, and workflow tools that reduce admin overhead.",
    bullets: [
      "AI chatbots trained on your business, services, and service area",
      "Automated lead follow-up across email and SMS",
      "Workflow automation that saves hours of manual admin per week",
    ],
    ...
    stat2: { v: "More leads", l: "Less manual follow-up" },
  },
];
