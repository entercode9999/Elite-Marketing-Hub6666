...
const SERVICES: Record<string, ServiceData> = {
  "seo-services": {
    ...
    shortLabel: "SEO",
    icon: Search,
    h1Template: "SEO Agency in [City], [Province]",
    titleTemplate: "SEO Agency in [City], [PA] | Outlier",
    taglineTemplate: "Outlier is [City]'s performance-driven SEO agency — page-1 rankings, compounding organic traffic, and qualified leads delivered by senior SEO specialists who know your market.",
    metaDescTemplate: "SEO agency in [City], [PA]. Outlier's senior SEO specialists build organic visibility that compounds — more traffic, more qualified leads. Free SEO audit.",
...
Our reporting model is built around the metrics that actually matter to a [City] business owner or marketing director: organic traffic growth, keyword rankings for commercially meaningful terms, qualified lead volume from organic channels, and revenue influenced by SEO. We don't hide behind impressions or "visibility scores" — you'll see exactly what your SEO investment is producing, and we'll have a clear conversation about what it will take to grow those numbers every quarter.`,
    ...
    faqTemplate: [
      ...
      { q: "How do I find a qualified SEO specialist in [City]?", a: "A qualified [City] SEO specialist should show you specific ranking results for businesses in your market, explain exactly what they will do and why, and report on metrics that connect to business outcomes — not just rankings for easy keywords. At Outlier, every [City] SEO engagement is led by a senior strategist with direct experience in the [City] market. Ask any agency to show you specific [City] case studies and their process for your specific category before committing." },
      { q: "What makes a [City] SEO agency actually effective?", a: "An effective [City] SEO agency understands that every market is different. The competitive dynamics of [City]'s [Region] location, the search behaviour of [City] buyers in [TopIndustry] and other sectors, and the specific technical and content standards required to outrank entrenched competitors — these are things a generic agency does not know. Outlier builds [City]-specific strategies that account for local competitive reality, not recycled frameworks reused from other markets." },
      { q: "What is the difference between an SEO agency and an internet marketing company for [City] businesses?", a: "In practice the terms overlap significantly. An SEO agency focuses on organic search rankings — technical SEO, content, and link building. An internet marketing company or digital marketing agency typically covers broader channels including SEO, paid search, social advertising, email, and content. Outlier operates as both: we run dedicated SEO programmes and full-channel digital marketing strategies for [City] businesses, depending on what produces the best ROI for your specific situation." },
      { q: "How do [City] SEO experts approach local vs. national rankings?", a: "For most [City] businesses, local rankings — appearing for '[service] in [City]' and neighbourhood-specific queries — produce the highest-value traffic because buyers searching with a city modifier have already made a geographic decision and are closer to purchase. Outlier's [City] SEO team builds programmes that capture both: local geo-modified queries for immediate high-converting traffic, and broader industry terms as domain authority compounds over time." },
    ],
    introHooks: [
...
Platform selection, deliverability, and list hygiene are technical foundations that most [City] businesses overlook — and that determine whether your emails land in inboxes or spam folders. We configure and manage your email platform (Klaviyo, HubSpot, Mailchimp, or your existing system) with deliverability best practices: proper SPF/DKIM/DMARC setup, list hygiene protocols, engagement-based sending, and domain warm-up procedures. [City] businesses that have struggled with low open rates and deliverability issues often see significant improvements within 60 days of implementing our technical foundation recommendations.`,
    ...
    faqTemplate: [
      { q: "Does email marketing still work for [City] businesses in 2026?", a: "Absolutely. Email marketing's ROI has actually improved over the past five years as social media reach has declined. For [City] businesses with existing customer relationships or lead pipelines, email remains the highest-ROI channel available — delivering $36 for every $1 invested on average. The key difference between email that works and email that doesn't is strategic execution: the right segmentation, automation, content, and cadence." },
...
The automation sequences we build for [City] clients cover the key commercial moments: new subscriber conversion, post-purchase follow-up, cart abandonment (for ecommerce), re-engagement, and loyalty. Each sequence is carefully structured with the right content, cadence, and offer for each [City] audience segment — and continuously refined based on performance data. Over time, these automations become a predictable revenue engine that doesn't require manual effort to operate.`,
  ...
  "digital-marketing": {
    ...
    taglineTemplate:
      "Outlier is a [City] digital marketing agency and internet marketing company — SEO, Google Ads, paid social, and email integrated into one accountable growth strategy.",
    metaDescTemplate: "Digital marketing agency in [City], [PA]. Outlier integrates SEO, Google Ads, paid social, and email into one accountable strategy. Measurable ROI. Free consultation.",
...
Attribution and measurement are the foundation of everything we do for [City] clients. We build custom attribution models that trace the full customer journey — from first touchpoint (organic search, paid ad, social post, referral) through every subsequent interaction to a closed deal. This allows us to understand the true contribution of each channel to your [City] business's revenue and optimise budget allocation accordingly. Over time, this data compounds: each month of operation improves the model's accuracy and our ability to drive incremental growth efficiently.`,
    ...
    faqTemplate: [
      ...
      { q: "What is an internet marketing company and is Outlier one?", a: "An internet marketing company — also called a digital marketing agency or digital marketing company — provides online marketing services including SEO, paid search, social media advertising, content marketing, email marketing, and web design. Outlier is a full-service internet marketing company serving [City] businesses. We manage every digital channel through a single integrated strategy and team, which means the data, messaging, and budget allocation across all channels are always coordinated. Unlike single-channel agencies, we see how all your channels interact and optimise the whole system." },
      { q: "How do I choose between digital marketing agencies in [City]?", a: "When comparing digital marketing agencies in [City], focus on three things: specific results they've produced for businesses in your market and category (not just generic case studies), how they report and attribute results (agencies that can't show clear lead and revenue attribution are optimising for vanity metrics), and the seniority of the team that will actually work on your account (many [City] agencies sell senior expertise and deliver junior execution). At Outlier, every [City] engagement is led by a senior strategist — not passed to a junior team after sign-off." },
      { q: "What is the difference between a digital marketing agency and a digital marketing company in [City]?", a: "The terms are used interchangeably in the [City] market. Both refer to businesses that provide digital marketing services — SEO, paid search, social media, content, email — to other businesses. Some [City] digital marketing companies focus on a single channel; others (like Outlier) offer integrated multi-channel strategies. The meaningful distinction is not in the name but in the service depth, the seniority of the team, and the quality of the reporting. Evaluate agencies and companies on the same criteria: specific results, transparent reporting, and a clear explanation of what they'll do and why." },
    ],
    introHooks: [
...
The [City] businesses we work with that achieve the strongest digital marketing outcomes treat it as a long-term investment, not a short-term spend. Paid channels deliver immediate results; SEO and content compound over 12–36 months; email builds increasing ROI as the list matures. The combined programme produces a cost of acquisition that drops consistently over time — and a competitive moat that becomes harder to close as the investment compounds.`,
  ...
  "web-design": {
    ...
    icon: Globe,
    h1Template: "Web Design Agency in [City], [Province]",
    titleTemplate: "Web Design Agency in [City], [PA] | Outlier",
    taglineTemplate:
      "Outlier is a [City] web design agency — custom web design and development that converts visitors into customers. Fast, SEO-ready, and built for growth.",
    metaDescTemplate: "Web design agency in [City], [PA]. Custom web design and development built for speed, SEO, and measurable growth. Outlier. Free consultation.",
...
The post-launch phase is where many [City] web design projects fail — not in the build, but in what happens after. We don't hand off and disappear. We monitor your new website closely for the first 30 days, tracking Core Web Vitals, crawl behaviour, indexation, and conversion metrics. We conduct monthly performance reviews for the first quarter post-launch, and we remain available for ongoing maintenance, CMS training, and content updates. If you're running an SEO or Google Ads programme with us, our web team stays closely integrated with your channel specialists to ensure the website continues to evolve in service of your growth objectives.`,
    ...
    faqTemplate: [
      ...
      { q: "What is custom web design and why does it matter for [City] businesses?", a: "Custom web design means your website is designed and built from scratch for your specific business, audience, and conversion objectives — not adapted from a template designed for someone else. For [City] businesses competing in a market where first impressions are made in milliseconds, a custom-designed website that reflects your brand, communicates your value clearly, and is optimised for the specific searches your [City] customers make consistently outperforms any template-based alternative on conversion rate, SEO performance, and brand credibility." },
      { q: "How does Outlier's web design agency approach differ from other [City] web design agencies?", a: "Most [City] web design agencies build beautiful websites that are not designed to rank or convert. Outlier is a web design agency that is also an SEO agency — every website we build has technical SEO built in from the first wireframe, not retrofitted after launch. This means your [City] website is both visually compelling and structurally optimised to rank in Google and convert the traffic it receives. We also build measurable conversion tracking into every project so you always know what your website investment is producing." },
      { q: "Do you offer web development services in [City] beyond website design?", a: "Yes. Web development at Outlier covers the full spectrum: custom WordPress development, Webflow builds, React and Next.js web applications, API integrations, CRM and booking system integrations, e-commerce development on Shopify and WooCommerce, and custom functionality builds for specific business requirements. Our [City] web development team handles both design-led builds and technically complex requirements. If your [City] business needs a web application rather than a standard website, we scope and deliver that too." },
      { q: "How much does web design cost in [City]?", a: "Web design investment for [City] businesses varies based on project scope, complexity, and the platform. A professionally designed, conversion-optimised [City] business website typically runs $6,000 to $20,000 as a project fee. More complex builds — e-commerce, custom applications, multi-location sites — run higher. Ongoing maintenance plans run $300 to $800 per month. We provide a fixed-fee proposal with a clear scope and timeline after a discovery call — no surprises, no hourly billing." },
    ],
    introHooks: [
...
Full-funnel social advertising is where the real efficiency gains emerge. Most [City] businesses running social ads are only running top-of-funnel awareness campaigns — reaching new audiences but not nurturing them through consideration and decision stages. We build complete social ad funnels: cold audience campaigns to generate awareness at the top, retargeting campaigns to re-engage warm audiences and drive conversions in the middle and lower funnel, and retention campaigns to drive repeat purchases and referrals from existing customers. This full-funnel approach maximises the return from every dollar of social ad spend and makes your [City] campaigns progressively more efficient over time.`,
    ...
    faqTemplate: [
      ...
      { q: "What creative formats perform best for social ads targeting [City] audiences in 2026?", a: "Short-form video (15–30 seconds) consistently outperforms static images on Meta, TikTok, and Instagram Reels for most [City] consumer categories — particularly for brand awareness and engagement objectives. For conversion-focused campaigns, static images and carousels often outperform video by making the offer and CTA immediately visible without requiring the viewer to watch. For [City] B2B campaigns on LinkedIn, document ads and thought leadership posts tend to generate the highest quality engagement. We test formats systematically for every [City] client rather than assuming one size fits all." },
