  ...
  return (
    <div className="min-h-screen bg-white flex flex-col selection:bg-primary selection:text-white">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 pt-[68px] min-h-screen">
        {/* Left: dark */}
        <div className="bg-[#08090d] flex flex-col justify-start px-10 lg:px-16 pt-10 pb-12 lg:pt-12 lg:pb-16 relative overflow-hidden">
        ...
        <div className="bg-[#f2f2ef] flex flex-col items-center justify-start px-8 pt-10 pb-12 lg:pt-12 lg:pb-16">
          <motion.div
