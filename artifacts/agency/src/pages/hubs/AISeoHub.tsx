...
const aiSeoData: HubData = {
  ...
  caseStudies: [
    { image: "/case-study-local.png", client: "Kotak Law", industry: "Legal Services", blurb: "Toronto law firm invisible in AI Overviews for key practice area queries. We implemented AEO content restructuring and E-E-A-T authority building. Now cited in Google AIO for 14 target practice area queries and receiving ChatGPT citations for Toronto legal services.", metrics: [{ value: "14", label: "AI Overview placements" }, { value: "+312%", label: "AI-referred traffic" }] },
