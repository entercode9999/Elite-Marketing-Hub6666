...
const socialAdsData: HubData = {
  ...
  faqs: [
    ...
    { question: "What ad budget do I need to run paid social?", answer: "The right media budget depends on your platform, industry, and campaign objectives. Different platforms have different cost-per-impression and cost-per-click dynamics, and we tailor our budget recommendations accordingly. Management fees are flat-rate — never a percentage of spend. We provide a specific budget recommendation after reviewing your goals and target audience." },
