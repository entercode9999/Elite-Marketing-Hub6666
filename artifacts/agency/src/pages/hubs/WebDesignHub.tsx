...
const webDesignData: HubData = {
  ...
  hero: {
    headline: "Toronto's Web Design Agency for Businesses That Want Results.",
    italic: "Custom web design and development. Built to convert.",
    description:
      "Outlier is a Toronto web design agency and web development company — custom web design, conversion optimisation, and web development for Canadian businesses that need a website that actually works. No templates. No page builders. Every project is built from scratch for your business, your audience, and your conversion goals.",
    cta: "Get a Free Website Audit",
    ctaHref: "/contact",
    badges: ["Toronto Web Design Agency", "Google Partner", "Clutch 5★", "100 Lighthouse Score"],
    visual: <HeroVisual />,
  },
  stats: [
    { value: "10+", label: "Years building Toronto websites" },
    { value: "320+", label: "Custom websites delivered" },
    { value: "+28%", label: "Avg. conversion rate lift" },
    { value: "100", label: "Avg. Lighthouse performance score" },
  ],
  intro: {
    eyebrow: "Why custom web design beats templates for Toronto businesses",
    headline: "A custom website from a Toronto web design agency outperforms any template — always.",
    body: "Template websites built on Squarespace, Wix, or generic WordPress themes are designed to work generically for any business. A custom website designed by a Toronto web design agency is built specifically for your business, your customers, and your conversion objectives. The difference shows up immediately: in load times, in conversion rates, in SEO performance, and in the credibility signal your brand sends to every visitor who lands on the page.",
    secondBody: "As a Toronto web design and web development company, Outlier builds every site with a primary conversion goal from day one. Every layout decision, headline, and call-to-action is tied to a measurable business outcome. We treat your website like the best-performing member of your sales team — because that's exactly what a well-built custom website should be.",
    bullets: [
      "Custom web design — no templates, no page builders, no recycled layouts",
      "Web development on WordPress, Webflow, and React/Next.js",
      "Built for Core Web Vitals and Lighthouse 100 performance scores",
      "Conversion-first architecture: every element has a measurable job",
